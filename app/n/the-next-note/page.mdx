...
<ArticleHeader title="the next note" date={metadata.date} />
...
progress lives in the space between now and next. absolutes exist in minds. reality flows note to note.
